...
export function QuickLinkCard({ title, icon: Icon, index = 0, className }: QuickLinkCardProps) {
  return (
    <motion.div
      ...
      whileTap={{ scale: 0.98 }}
    >
      <Card className={cn("group cursor-pointer hover:border-slate-300 transition-all rounded-2xl shadow-sm border-slate-200", className)}>
